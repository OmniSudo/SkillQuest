...
public class BVH{
     public Polygon? Intersect(Vector2 pos) {
    ...
    private Polygon? Intersect(Node branch, Vector2 pos) {
    ...
    private class Node {
        ...
        public Node(HashSet<Polygon> polygons) {
            ...
            if (polygons.Count > 0) {
                ...
                this.bounds = new Rect(new Vector2(0, 0), new Vector2(0, 0));
            }
        }
    }
    ...
    private Node BuildBVH(Node node) {
        ...
        Vector2 delta = bounds.Max - bounds.Min;
        ...
        foreach (var polygon in node.polygons) {
            ...
            Vector2 center = polygon.Bounds.Center!.Value;
